...
local v12OriginalHumanoidState = {}
...
local function setupRemoteListener(obj)
    ...
    pcall(function()
            ...
            remoteListeners[obj] = connection
        end)
    end
...
local function v13SetModule(name, running, detail)
    v13ModuleState[name] = {Running = running == true, Detail = tostring(detail or ""), Updated = v13Now()}
end

local function v13TimelineAdd(kind, message, data)
    local item = {
        ID = #v13Timeline + 1,
        Timestamp = v13Now(),
...
local function v13RenderDashboard()
    v13ClearContent()
    v13AddLabel("RE Ultimate Console v13 | لوحة التحكم", Color3.fromRGB(160, 220, 255), 24)
    v13AddLabel("الوضع: " .. (consoleActive and "شغال" or "متوقف") .. " | Safe Mode: " .. (v13SafeMode and "مفعّل" or "مفعّل افتراضياً"), Color3.fromRGB(180, 255, 180), 24)
...
local function v13RenderLogs()
    v13ClearContent()
    v13AddLabel("السجلات | سجلات V12 المجمعة محلياً", Color3.fromRGB(160, 220, 255), 24)
...
local function v13RenderRemotes()
    v13ClearContent()
    v13AddLabel("الريموتات | Remote Discovery و Remote Activity", Color3.fromRGB(160, 220, 255), 24)
...
local function v13RenderSecurity()
    v13ClearContent()
    v13AddLabel("الأمان | Safe Mode هو الوضع الافتراضي", Color3.fromRGB(255, 220, 150), 24)
...
local function v13RenderFindings()
    v13ClearContent()
    v13AddLabel("النتائج | Findings و Evidence", Color3.fromRGB(255, 220, 150), 24)
...
local function v13RenderTimeline()
    v13ClearContent()
    v13AddLabel("الخط الزمني | Timeline", Color3.fromRGB(160, 220, 255), 24)
...
local v13TabBar = Instance.new("Frame")
v13TabBar.Size = UDim2.new(1, -10, 0, 30)
v13TabBar.Position = UDim2.new(0, 5, 0, 65)
...
for index, tabName in ipairs(v13TabNames) do
    local tabButton = createButton(v13TabBar, (index - 1) * 67, 0, 65, 28, tabName)
...
local v13OpenButton = createButton(toolbarFrame, 560, 0, 50, 28, "v13")
v13OpenButton.BackgroundColor3 = Color3.fromRGB(55, 110, 155)
