...
task.defer(function()
    pcall(function()
        ...
        if inspectorFrame then inspectorFrame.BackgroundColor3 = RE_DESIGN.Colors.GlassDeep end
        if aiFrame then aiFrame.BackgroundColor3 = RE_DESIGN.Colors.Card end
        if modelFrame then modelFrame.BackgroundColor3 = RE_DESIGN.Colors.Floating end
