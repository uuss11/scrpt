...
local reBootParentSet = false
local gui = Instance.new("ScreenGui")
gui.Name = "RE_Ultimate_Framework"
-- RE_V13_MINIMAL_GUI_BOOT
...
reBootParentSet = gui.Parent ~= nil
local reBootIcon = Instance.new("TextButton")
reBootIcon.Size = UDim2.new(0, 40, 0, 40)
reBootIcon.Position = UDim2.new(0, 15, 0, 15)
reBootIcon.BackgroundColor3 = Color3.fromRGB(38, 34, 58)
reBootIcon.BorderSizePixel = 0
reBootIcon.Text = "RE"
reBootIcon.TextColor3 = Color3.fromRGB(248, 247, 255)
reBootIcon.TextSize = 16
reBootIcon.Font = Enum.Font.GothamBold
reBootIcon.Visible = true
reBootIcon.Active = true
reBootIcon.Selectable = true
reBootIcon.ZIndex = 1000
reBootIcon.Parent = gui
...
-- V13 minimal bootstrap already created gui

local guiParentSet = reBootParentSet
